...
python src/web_demo.py \
    --model_name_or_path ./weights/Llama-2-7b-chat-hf \
...
```python
python cli_demo.py --model_name_or_path ./weights/Llama-2-7b-chat-hf --checkpoint_dir ./weights/adapter --finetuning_type lora --template llama2
```
